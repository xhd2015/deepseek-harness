...
export const zh = {
  'draft.persistenceFailed': '无法同步会话草稿。当前编辑内容仍保留在此浏览器中。',
...
export const en = {
  'draft.persistenceFailed': 'Could not synchronize the session draft. Your current edits remain in this browser.',
