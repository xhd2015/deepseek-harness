...
| Profile | Arguments |
|---|---|
| `web` | `--host`, `--port`, repeatable `--trusted-host`, repeatable `--trusted-host-for-settings`, `--no-open`, `--browser`, `open [dir]` |
